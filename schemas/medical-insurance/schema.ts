...
export const MedicalInsuranceElementSchema = z.object({
    ...
    "medical_insurance_type_id": z.union([z.array(z.union([MedicalInsuranceTypeIdEnumSchema, z.number()])), z.boolean()]),
    "medical_insurance_category_id": z.union([z.array(z.union([MedicalInsuranceCategoryIdEnumSchema, z.number()])), z.boolean()]),
